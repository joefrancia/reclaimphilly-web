...
urlpatterns = patterns('',
    ...
    url(r'^services/put/location$', 'reclaimphilly_web.rest_services.add_location'),
    # TODO This is a scary regular expression - revise later
    # TODO:  Data manipulation should be POSTed, so the regex can mostly be eliminated
)
